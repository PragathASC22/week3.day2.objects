...
// an error.
heroCreator.populateGrid(gridDiv, heros);
...
let allHeroContainers = document.querySelectorAll(".hero_container")
...
function removeIds() {
    allHeroContainers.removeAttribute("id")
}
...
for (let i = 0; i< allHeroContainers.length; i++) {
    allHeroContainers[i].onclick = highlightHero;
}
